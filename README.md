...
1. Отправьте команду `/evaluate`
2. Дождитесь завершения оценки (1-2 минуты)
3. Сделайте скриншот результатов
4. Сохраните как `screenshots/evaluate_command.png`
...
**Как сделать скриншот:**
1. После выполнения `/evaluate`
2. Прокрутите вниз до детальных результатов
3. Сделайте скриншот
4. Сохраните как `screenshots/detailed_results.png`

> **Инструкция по добавлению скриншотов:**
> 1. Создайте папку `screenshots/` в корне проекта
> 2. Сделайте скриншоты согласно инструкциям выше
> 3. Сохраните их с указанными именами
> 4. Скриншоты будут автоматически включены в репозиторий
